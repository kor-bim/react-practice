export const NaverBlogIcon = ({ fill = 'currentColor', size = 24, height = 24, width = 24, ...props }) => {
  return (
    <svg
      fill={fill}
      width={size || width || 24}
      ...
      viewBox="0 0 10.83 10.04"
      {...props}
    >
      <g>
        <g>
          <path d="M2.36,3.71A.37.37,0,0,0,2,4.08a.38.38,0,0,0,.75,0A.37.37,0,0,0,2.36,3.71Z" />
          <path d="M6.05,3.67a.4.4,0,1,0,.4.4A.4.4,0,0,0,6.05,3.67Z" />
          ...
          <path d="M8.51,3.68a.39.39,0,0,0,0,.78.39.39,0,0,0,0-.78Z" />
        </g>
      </g>
    </svg>
  )
